            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <p className="text-lg leading-relaxed dark:text-white mt-0 mb-4 text-blueGray-600">
                  Some frameworks I have experience using include: Spring Boot, Next.js, Django, and Flutter.
                </p>
            ...
            <div className="items-center flex flex-wrap flex-row-reverse">
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  ...
                  <h3 className="text-3xl dark:text-white text-black font-semibold">No longer doing work for clients</h3>
              ...
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-white">
                  ...
                  />
                  <blockquote className="relative p-8 pt-16 mb-4">
                    <h4 className="text-xl font-bold text-black">Not taking any clients</h4>
                    <p className="mt-4 text-lg leading-relaxed text-black">
                      Due to my current position at SAIC, I am no longer taking on work for clients. 
                    </p>
                  </blockquote>
                </div>
              </div>
